...
//
// IMPORTANT:
//   CAD_DONE tells us the CAD operation completed.
//   CAD_DETECTED is the actual channel-activity event we
//   want to propagate to DIO1.
// ============================================================
...
void sxConfigureCadIrq()
{
  ...
  // GLOBAL IRQ MASK
  //
  // Keep BOTH events visible in IRQ status.
  // ----------------------------------------------------------
